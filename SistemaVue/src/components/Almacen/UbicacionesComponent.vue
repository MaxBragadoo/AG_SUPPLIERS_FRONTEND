<template>
    <v-data-table :headers="headers" :items="ubicaciones" :search="search"
...
export default {
    data: () => ({
        ...
        headers: [
            ...
            { title: 'ID Ubicacion', value: 'idubicacion', key: 'idubicacion' },
        ...
        //valida: 0,
        //Este adModal lo cambie de 0 a false 23 - jul -2024
        adModal: false,
        validaMensaje: [],       
        adAccion: 0,
        adNombre: '',
    ...
    computed: {
        formTitle() {
            return this.editedIndex === -1 ? 'Nueva Ubicación' : 'Actualizar Ubicación'
        },
    },
    ...
    methods: {
        //Metodo para poder cargar los datos de la BD Ubicaciones
        listar() {
            let me = this;
            axios.get('api/Ubicaciones/Listar').then(function (response) {
        ...
        guardar() {
          ...
          //  }
            ...
            if (this.editedIndex > -1) {
                ...
                let me = this;
                axios.post('api/Ubicaciones/Crear', {
                    'nombre': me.nombre,
                    'descripcion': me.descripcion,
      ...
      /*  validar(){
        ...
        activarDesactivarCerrar(){
            //ESte tambien lo cambie de 0 a false 23 - jul -2024
            this.adModal=false;
        },
        //Metodo para activar una categoria en el modal
        activar(){
            let me=this;
            axios.put('api/Ubicaciones/Activar/'+ this.adId,{}).then(function(response){
                me.adModal=false;
                me.adAccion = 0;
                me.adNombre="";
                me.adId;
        ...
        desactivar(){
            let me=this;
            axios.put('api/Ubicaciones/Desactivar/'+ this.adId,{}).then(function(response){
                me.adModal = false;
                me.adAccion = 0;
                me.adNombre="";
                me.adId;
