      ...
      <v-navigation-drawer 
        ...
        <v-list v-model:opened="open">
          ...
          <v-list-group value="Compras">
            <template v-slot:activator="{ props }">
              <v-list-item v-bind="props" prepend-icon="mdi-dolly" title="Compras"></v-list-item>
            </template>              
          ...
          <v-list-group value="Orden Trabajo">
            <template v-slot:activator="{ props }">
              <v-list-item v-bind="props" prepend-icon="mdi-airplane" title="Orden Trabajo"></v-list-item>
            </template>

            <v-list-group value="_ot">
            <template v-slot:activator="{ props }">
              <v-list-item v-bind="props" prepend-icon="mdi-folder-text-outline" title="Catalogos"></v-list-item>
            </template>              
...
export default {
  ...
  data: () => ({
    ...
    catalogos_ot: [
        ['Modelo', 'mdi-warehouse','Ot_modelo'],
        ['Aeronave', 'mdi-warehouse', 'Ot_aeronave'],
        ['Programada', 'mdi-unity','Ot_programada'],
        ['Cliente','mdi-group','Ot_cliente']
      ],
      gestion_ot: [
